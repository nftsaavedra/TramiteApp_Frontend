...
// Se actualiza la interfaz para recibir las funciones de acción
...
export function OficinasDataTable({
  ...
  const table = useReactTable({
    ...
    // Se pasa la data a la metadata para que las acciones de fila tengan acceso
    meta: {
      onEdit,
      onDelete,
    },
  ...
  return (
    <div className='space-y-4'>
      {/* Se pasa la función `onCreate` al Toolbar */}
